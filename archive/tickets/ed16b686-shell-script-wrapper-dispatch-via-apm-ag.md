...
updated_at = "2026-05-04T20:20:53.104471Z"
epic = "5acea599"
...
- [x] `wrapper.sh` passes `--dangerously-skip-permissions` when `APM_SKIP_PERMISSIONS` equals `"1"`
- [x] `wrapper.sh` passes `--model "$APM_MODEL"` when `APM_MODEL` is non-empty
- [x] The env-var setup for custom wrapper scripts includes `APM_MODEL` (set from `ctx.model`)
...
| 2026-05-04T17:31Z | in_design | specd | claude-0504-1727-9ea8 |
| 2026-05-04T19:18Z | specd | ready | philippepascal |
| 2026-05-04T19:32Z | ready | in_progress | philippepascal |
| 2026-05-04T19:41Z | in_progress | implemented | claude-0504-1932-9668 |
