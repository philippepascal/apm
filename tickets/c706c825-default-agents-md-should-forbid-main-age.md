...
updated_at = "2026-04-24T07:26:11.662700Z"
+++
...
- [x] The paragraph explicitly forbids `apm epic close`
- [x] The paragraph states which transitions the main agent *may* initiate: `new → closed` (cancel a ticket created in error) and any transition the workflow marks `actionable = ["agent"]` when the agent is the assignee
