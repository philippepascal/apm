...
updated_at = "2026-04-12T07:15:30.245578Z"
epic = "57bce963"
...
- [x] `apm_core::start::resolve_caller_name()` no longer exists (removed from `start.rs`)
...
- [x] `cargo test` passes across the full workspace with no compilation errors
