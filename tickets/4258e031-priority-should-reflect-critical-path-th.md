...
updated_at = "2026-04-02T18:10:19.938106Z"
+++
...
- [ ] Effective priority propagates transitively: if A (priority 2) blocks B (priority 5) which blocks C (priority 9), A's effective priority is 9
