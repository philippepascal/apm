...
updated_at = "2026-04-04T18:12:58.104558Z"
epic = "8db73240"
...
- [x] `apm list --mine` does not return tickets where neither `author` nor `owner` matches the current user
- [x] `apm list --owner alice` returns only tickets whose `owner` field equals `"alice"`
- [x] `apm list --owner alice` does not return tickets authored by alice but not owned by alice
...
- [x] Update approach code snippets: `fm.agent.as_deref()` → `fm.owner.as_deref()`, parameter names in `list_filtered` signature
...
| 2026-04-04T07:40Z | ammend | in_design | philippepascal |
| 2026-04-04T07:42Z | in_design | specd | claude-0404-0742-x9k2 |
| 2026-04-04T15:34Z | specd | ready | apm |
| 2026-04-04T17:26Z | ready | in_progress | philippepascal |
| 2026-04-04T17:33Z | in_progress | implemented | claude-0404-1730-w8k3 |
