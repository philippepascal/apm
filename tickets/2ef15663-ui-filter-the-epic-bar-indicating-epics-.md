...
updated_at = "2026-06-01T17:46:49.238094Z"
+++
...
- [x] When no epic filter is active, the epic bar shows all stale epics that appear in any ticket (existing behaviour unchanged)
- [x] When a specific epic ID is selected in the epic filter and that epic is stale, the epic bar shows exactly one badge for that epic
- [x] When a specific epic ID is selected in the epic filter and that epic is not stale, the epic bar is hidden
- [x] When the "No epic" filter (`__none__`) is active, the epic bar is hidden
- [x] Stale epics that belong to a different epic than the active filter are not shown in the epic bar while that filter is active
...
| 2026-06-01T17:46Z | implemented | closed | philippepascal(apm-sync) |
