...
updated_at = "2026-04-07T22:39:39.265196Z"
+++
...
- [x] Each command section includes a SYNOPSIS block showing the exact invocation syntax with arguments and flags
- [x] Each command section lists every flag and argument with its type, default (if any), and a one-sentence description
- [x] Each command section that performs git operations includes a "Git internals" subsection listing each git call and a one-sentence explanation of why it is needed
...
- [x] The document includes a top-level introduction section explaining what APM is and how to navigate the reference
- [x] The document groups commands into logical sections (e.g. Ticket lifecycle, Inspection, Workflow orchestration, Administration, Server)
...
| 2026-04-07T19:49Z | in_progress | implemented | claude-0407-1933-4188 |
