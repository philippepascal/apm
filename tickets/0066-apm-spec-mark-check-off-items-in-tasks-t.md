...
updated_at = "2026-03-29T23:56:25.724928Z"
+++
...
- [ ] `apm spec <id> --section <name> --mark <item-text>` finds the first unchecked item (`- [ ]`) in `### <name>` whose text matches `<item-text>` (case-insensitive substring) and marks it `- [x]`
