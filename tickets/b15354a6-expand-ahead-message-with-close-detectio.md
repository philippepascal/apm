...
updated_at = "2026-04-18T06:54:30.031534Z"
+++
...
- [x] When `apm sync` (CLI) runs and local default branch is ahead of origin, the expanded message appears on stderr
- [x] When `POST /api/sync` runs and local default branch is ahead of origin, the `log` field in the JSON response contains the expanded `MAIN_AHEAD` message
...
| 2026-04-18T02:33Z | in_design | specd | claude-0418-0229-b9e0 |
