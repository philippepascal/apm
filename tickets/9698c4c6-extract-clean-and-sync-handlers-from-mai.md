...
updated_at = "2026-04-12T10:19:38.706800Z"
epic = "1e706443"
...
- [ ] Remove CleanRequest from scope. Prerequisite a6bc1326 already moves it to `models.rs` — it will not be in `main.rs` when this ticket runs. The handler should import it from `crate::models`.
- [ ] Update acceptance criteria: change "handlers/maintenance.rs exists and contains the CleanRequest struct" to "handlers/maintenance.rs imports CleanRequest from crate::models".
