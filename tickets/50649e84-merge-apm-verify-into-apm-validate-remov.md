...
updated_at = "2026-04-28T20:43:34.401629Z"
+++
...
- [x] `apm validate` reports tickets whose branch is already merged into the default branch but whose state is not closed
- [x] `apm validate` reports tickets in `in_design` or `in_progress` states whose worktree directory is absent from disk
...
- [x] `apm validate --json` includes issues from the full merged check set in its structured output
...
- [x] Approach must explicitly say "remove the `Verify` arm from `is_read_only_command` entirely" — not "comment out" — to prevent accidental resurrection if someone later uncomments dead code.
...
| 2026-04-28T19:37Z | in_design | specd | claude-0428-1933-c858 |
| 2026-04-28T20:17Z | specd | ammend | philippepascal |
| 2026-04-28T20:21Z | ammend | in_design | philippepascal |
| 2026-04-28T20:23Z | in_design | specd | claude-0428-2021-fc50 |
